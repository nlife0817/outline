...
export const buildLightTheme = (input: Partial<Colors>): DefaultTheme => {
  ...
  return {
    ...
    sidebarHoverBackground: "rgba(15, 23, 42, 0.04)",
    sidebarActiveBackground: "rgba(52, 109, 219, 0.10)",
    sidebarControlHoverBackground: "rgba(15, 23, 42, 0.06)",
    sidebarDraftBorder: "hsl(212 31% 75% / 1)",
    sidebarText: "rgb(82, 92, 108)",
...
export const buildDarkTheme = (input: Partial<Colors>): DefaultTheme => {
  ...
  return {
    ...
    placeholder: "#596673",
    sidebarBackground: colors.almostBlack,
    sidebarHoverBackground: "rgba(255,255,255,0.05)",
    sidebarActiveBackground: "rgba(52, 109, 219, 0.20)",
